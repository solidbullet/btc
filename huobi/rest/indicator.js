var Indicator = (function(){
   ...
   * @return {Array} listMA
   */
  var sma= function(list1,n){
    let listMA = [];
    let list2 = [];
    // let start = 0;
    for(let i = 0;i< list1.length - n;i++ ){
      // start = i-(n-1);
      // start = (start >= 0)?start:0;
      list2 = list1.slice(i,i+n);
      // console.log(list2);
      listMA.push(ma_avg(list2));
    }
    return listMA;
  }
  ...
  return {"OBV": obv, "MACD": macd, "KDJ": kdj, "BOLL": boll, "RSI": rsi, "MA": ma,"SMA":sma};
})();
